      ...
      <details className="group">
        ...
        {events.length > 0 ? (
          ...
          /* **L'état vide est le premier rendu de tous les projets existants** :
             ...
             aucun geste à proposer — on n'écrit pas dans le journal. La phrase
             est **celle qui annonçait le bloc** dans `REFERENCE_BLOCKS` :
             l'annonce devient l'attente, rien ne s'invente. */
          <BlockNote className="mt-4">
            Qui a modifié quoi, et quand. Une information de contrôle : elle sert
            à retrouver l&apos;origine d&apos;une saisie, pas à comprendre
            l&apos;accompagnement.
          </BlockNote>
        )}
      </details>
